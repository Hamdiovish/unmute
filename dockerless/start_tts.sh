...
[ -f pyproject.toml ] || wget https://raw.githubusercontent.com/Hamdiovish/moshi/refs/heads/main/rust/moshi-server/pyproject.toml
[ -f uv.lock ] || wget https://raw.githubusercontent.com/Hamdiovish/moshi/refs/heads/main/rust/moshi-server/uv.lock
